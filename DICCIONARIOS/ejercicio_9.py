...
def agregarFactura(numFra, importe):

    facturas = {}
    facturas[numFra] = importe

    return facturas

def eliminarFactura(numFra, diccionario):

    del diccionario[numFra]
    return diccionario

salir = False
opcion = 0

while not salir or opcion > 0 and opcion < 3:
    mostrarMenu()
