""" El directorio de los clientes de una empresa está organizado en una cadena de texto como la de más abajo, donde
    cada línea contiene la información del nombre, email, teléfono, nif, y el descuento que se le aplica. Las líneas se
    ...
    información de cada cliente correspondientes a los campos. Es decir, un diccionario como el siguiente (ver
    diccionario_muestra.txt):
    ...
    'email': 'juanjo@mail.com', 'teléfono': '664888233', 'descuento': 5.2}, '98376547F':
    {'nombre': 'Carmen Sánchez', 'email': 'carmen@mail.com', 'teléfono': '667677855', 'descuento': 15.7}}. """
...
while opcion != 'n':
    ...
    descuento = input("Introduzca el descuento: ")

    cliente = {'nombre':nombre, 'email':email, 'teléfono':telefono, 'descuento':descuento}
    clientes[nif] = cliente

    opcion = input("¿Otro cliente?(s/n): ")
