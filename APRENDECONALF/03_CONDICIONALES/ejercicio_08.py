...
puntuacion = float(input("Introduzca la puntuación del usuario: "))
base = 2400
nivel = ""

"""
if puntuacion < 0.4:
    print("El nivel es Inaceptable. El dinero a cobrar es 0.00€")
elif puntuacion < 0.6:
    print("El nivel es Aceptable. El dinero a cobrar es", (base * puntuacion) + base)
else:
    print("El nivel es Meritorio. El dinero a cobrar es", base * puntuacion) """
...
print(f"El nivel es {nivel}. El dinero a cobrar es:", base * puntuacion)
